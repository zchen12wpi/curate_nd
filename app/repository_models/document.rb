class Document < GenericWork
  ...
  DOCUMENT_TYPES = [
    'Book', 'Book Chapter', 'Brochure', 'Catholic Document' 'Document', 'Letter',
    'Manuscript', 'Newsletter', 'OpenCourseWare', 'Pamphlet', 'Presentation',
    'Press Release', 'Report', 'Software', 'White Paper', 'Video'
  ].freeze
