...
class AudioDatastream < ActiveFedora::NtriplesRDFDatastream
  ...
  #conductor(s)
  property :conductor, predicate: ::RDF::Vocab::MARCRelators.cnd do |index|
    index.as :stored_searchable
  end

  #author(s) of material used in the work
  property :work_author, predicate: ::RDF::Vocab::MARCRelators.aut do |index|
    index.as :stored_searchable
  end
  ...
  property :original_media_source, predicate: ::RDF::Vocab::EBUCore.isDerivedFrom
