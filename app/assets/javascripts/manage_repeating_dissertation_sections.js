...
(function($){
  ...
  $.widget( 'curate.manage_dissertation_sections', {
    options: {
      change: null,
      add: null,
      remove: null
    ...
    add_to_section_list: function( event ) {
      ...
      if ($lastNameField.val() === '') {
        ...
        var $nameFieldCell = $newField.children('td.name')
                       ...
                       .children('div')
                       .children('input')
                       .attr('id', 'dissertation_contributor_attributes_' + rowNumber + '_contributor')
                       .attr('name', 'dissertation[contributor_attributes][' + rowNumber + '][contributor]');

        var $roleFieldCell = $newField.children('td.role')
                       .last()
                       .children('div')
                       .children('input')
                       .attr('id', 'dissertation_contributor_attributes_' + rowNumber + '_role')
                       .attr('name', 'dissertation[contributor_attributes][' + rowNumber + '][role]');
